...
output "cluster_id" {
  ...
  value       = var.deploy_eks ? module.gdp_aws-eks.cluster_id : null
}

output "cluster_name" {
  description = "The name of the EKS cluster"
  value       = var.deploy_eks ? module.gdp_aws-eks.cluster_name : var.external_eks_cluster_name
}

output "cluster_endpoint" {
  description = "Endpoint for EKS control plane"
  value       = var.deploy_eks ? module.gdp_aws-eks.cluster_endpoint : null
}

output "cluster_security_group_id" {
  description = "Security group ID attached to the EKS cluster"
  value       = var.deploy_eks ? module.gdp_aws-eks.cluster_security_group_id : null
}

output "cluster_iam_role_arn" {
  description = "IAM role ARN of the EKS cluster"
  value       = var.deploy_eks ? module.gdp_aws-eks.cluster_iam_role_arn : null
}

output "cluster_certificate_authority_data" {
  description = "Base64 encoded certificate data required to communicate with the cluster"
  value       = var.deploy_eks ? module.gdp_aws-eks.cluster_certificate_authority_data : null
  sensitive   = true
}

output "cluster_oidc_issuer_url" {
  description = "The URL on the EKS cluster OIDC Issuer"
  value       = var.deploy_eks ? module.gdp_aws-eks.cluster_oidc_issuer_url : null
}

output "oidc_provider_arn" {
  description = "ARN of the OIDC Provider for EKS"
  value       = var.deploy_eks ? module.gdp_aws-eks.oidc_provider_arn : null
}
...
output "vpc_id" {
  ...
  value       = var.deploy_eks ? module.gdp_aws-eks.vpc_id : null
}

output "private_subnets" {
  description = "List of IDs of private subnets"
  value       = var.deploy_eks ? module.gdp_aws-eks.private_subnets : null
}

output "public_subnets" {
  description = "List of IDs of public subnets"
  value       = var.deploy_eks ? module.gdp_aws-eks.public_subnets : null
}
...
output "node_security_group_id" {
  ...
  value       = var.deploy_eks ? module.gdp_aws-eks.node_security_group_id : null
}

output "node_group_id" {
  description = "EKS node group ID"
  value       = var.deploy_eks ? module.gdp_aws-eks.node_group_id : null
}

output "node_group_arn" {
  description = "Amazon Resource Name (ARN) of the EKS Node Group"
  value       = var.deploy_eks ? module.gdp_aws-eks.node_group_arn : null
}

output "node_group_status" {
  description = "Status of the EKS node group"
  value       = var.deploy_eks ? module.gdp_aws-eks.node_group_status : null
}
...
output "ebs_csi_driver_role_arn" {
  ...
  value       = var.deploy_eks ? module.gdp_aws-eks.ebs_csi_driver_role_arn : null
}

output "efs_csi_driver_role_arn" {
  description = "ARN of IAM role for EFS CSI driver"
  value       = var.deploy_eks ? module.gdp_aws-eks.efs_csi_driver_role_arn : null
}

output "efs_id" {
  description = "The ID of the EFS file system"
  value       = var.deploy_eks ? module.gdp_aws-eks.efs_id : null
}

output "efs_dns_name" {
  description = "The DNS name of the EFS file system"
  value       = var.deploy_eks ? module.gdp_aws-eks.efs_dns_name : null
}

output "ebs_storage_class_name" {
  description = "Name of the EBS storage class"
  value       = var.deploy_eks ? module.gdp_aws-eks.ebs_storage_class_name : null
}

output "efs_storage_class_name" {
  description = "Name of the EFS storage class"
  value       = var.deploy_eks ? module.gdp_aws-eks.efs_storage_class_name : null
}
...
output "configure_kubectl" {
  ...
  value       = var.deploy_eks ? module.gdp_aws-eks.configure_kubectl : null
}

output "kubeconfig" {
  description = "Generated kubeconfig content (no AWS CLI required). Usage: terraform output -raw kubeconfig > ~/.kube/config"
  sensitive   = true
  value       = var.deploy_eks ? module.gdp_aws-eks.kubeconfig : null
}
...
output "deployment_summary" {
  ...
  value = {
    cluster_name       = var.deploy_eks ? module.gdp_aws-eks.cluster_name : var.external_eks_cluster_name
    cluster_endpoint   = var.deploy_eks ? module.gdp_aws-eks.cluster_endpoint : null
    kubernetes_version = var.kubernetes_version
    aws_region         = var.aws_region
    vpc_id             = var.deploy_eks ? module.gdp_aws-eks.vpc_id : null
    node_group_status  = var.deploy_eks ? module.gdp_aws-eks.node_group_status : null
...
output "access_instructions" {
  ...
  value = var.deploy_eks ? join("\n", [
    ...
    "  ${module.gdp_aws-eks.configure_kubectl}",
    "",
    "1. Use the generated kubeconfig:",
    "   export KUBECONFIG=${module.gdp_aws-eks.configure_kubectl}",
