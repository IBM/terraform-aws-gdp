# Create GDP Collector for AWS

## Introduction

This module creates a GDP Collector on AWS.

## Parameters

All parameters must be modified in the terraform.tfvars file. See the [documentation](../../examples/collector/README.md) in the example for instructions.
...
### Parameter to register to Aggregator

See the [documentation](../../examples/collector/README.md) in the example for instructions how to setup the Collector so that it will register to an Aggregator you created earlier.
